...
FCKConfig.LinkBrowserWindowWidth	= 780 ;		// 70%
FCKConfig.LinkBrowserWindowHeight	= 440 ;	// 70%

FCKConfig.ImageBrowser 				= true ;
FCKConfig.ImageBrowserURL 			= FCKConfig.PluginsPath + 'ajaxfilemanager/ajaxfilemanager.php';
FCKConfig.ImageBrowserWindowWidth  	= 780 ;	// 70% ;
FCKConfig.ImageBrowserWindowHeight 	= 440 ;	// 70% ;

FCKConfig.FlashBrowser 				= true ;
FCKConfig.FlashBrowserURL 			= FCKConfig.PluginsPath + 'ajaxfilemanager/ajaxfilemanager.php';
FCKConfig.FlashBrowserWindowWidth  	= 780 ;	//70% ;
FCKConfig.FlashBrowserWindowHeight 	= 440 ;	//70% ;
